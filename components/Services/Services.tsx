...
export const Services = () => {
  return (
    <div className="w-full h-[1423px] pt-20 bg-serviceBg">
                ...
                <div className=" lg:w-1/3 md:w-1/2 w-full mt-4 " key={`${service.id}`}>
                  ...
                  >
                    ...
                    <div className="flex-grow mt-4 flex flex-col justify-evenly">
                      ...
                      <p className="font-Lato text-pColor font-medium text-xl leading-[30px] w-[270px] h-[120px] text-justify not-italic">
                        {service.description}
                      </p>
                    </div>
                  </div>
