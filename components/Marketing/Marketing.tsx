...
export const Marketing = () => {
  ...
  return (
    <section className="w-full h-auto md:h-auto  bg-serviceBg">
      <div className="container px-16 py-24 md:px-8 sm:px-6 sm:py-8  mx-auto ">
        ...
        <div className="flex flex-wrap  lg:px-0 md:px-2 justify-around sm:w-full sm:h-auto sm:px-4">
