...
export const Marketing = () => {
  return (
    <section className="w-full h-[944px] md:h-auto  bg-serviceBg">
      <div className="container px-16 py-24 md:px-8 sm:px-4 sm:py-8  mx-auto ">
        ...
        <div className="flex flex-wrap justify-around sm:w-full sm:h-auto sm:px-4">
          {marketingData.map((data) => (
            <div
              className={`pl-3 pr-8 pt-8  h-[242px] md:h-auto w-1/2 sm:w-full sm:h-auto sm:my-2 hover:border-main hover:bg-white hover:border-b-4 r  hover:shadow-service 
               ${data.id > 2 ? "mt-12" : "mt-6"}`}
              key={`${data.id}`}
            >
