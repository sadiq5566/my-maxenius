...
export const Feedback = () => {
  return (
    <section className="w-full h-[765px] sm:h-auto ">
      <div className="flex sm:flex-col justify-between items-center pt-16 px-28">
        <div className="flex sm:text-left sm:w-full">
          <h1 className="inline md:text-[22px] md:font-normal md:leading[30px] font-poppins md:w-full font-normal text-4xl leading-[48px] text-black">
            Maxenius Success Stories
            <span className="ml-7 sm:h-auto">
              <HalfRedStarSVG />
            </span>
      ...
      <div className="w-full mx-auto flex px-5 md:px-28 mt-24 mb-20 flex-row sm:flex-col items-center">
        <div className="w-1/3 sm:w-full flex items-center justify-center overflow-hidden">
          <Image
            src={client}
            alt="image of client"
        ...
        <div className="w-2/3 sm:w-full lg:pl-[40px] pr-20 sm:h-auto sm:mt-24 h-[308px] md:h-auto flex flex-col justify-between">
          <div className="flex ">
            <p className="font-Lato font-medium  text-[20px] md:text-xs md:font-medium md:mt-4 md:leading-5 leading-9 lg:leading-6 text-pColor text-justify w-auto sm:w-full md:px-4">
              Usama has performed an excellent Job, went beyond and above my expectations,
              despite being on a very tight budget. He was very professional, responsive,
              helpful, and trustworthy though the project was time consuming as well as
              little bit complicated beyond what was expected. I will definitely be using
          ...
          <div className="w-auto  lg:w-auto flex flex-col md:px-4 sm:pl-0 sm:mt-16">
            ...
            <p className="w-[679px] md:w-full sm:text-center md:text-xs md:font-medium md:leading-5 sm:mt-6 font-Lato font-medium text-lg leading-9 text-justify text-pColor">
              Bedrock Impact Group & Maxenius Advisor
            </p>
          </div>
        </div>
