...
export function Header({ title, subTitle }: HeaderProps) {
  ...
  return (
    ...
    >
      ...
      <section className="relative">
        <div
          className={`px-14 py-24 lg:py-18 md:px-7 md:py-6 mx-auto flex flex-nowrap sm:flex-col sm:px-6 sm:py-6 sm:h-auto ${
            router.pathname === "/ourwork" ? "justify-between items-center" : ""
          }`}
        >
          <div
            ...
            {router.pathname === "/ourwork" || router.pathname === "/services" ? (
              ...
              <div className="sm:h-auto lg:mt-2 w-auto sm:mt-0">
                <div className="flex mb-1  ">
                  <h3 className="text-4xl font-normal lg:mb-2 lg:text-[22px] lg:leading-6 font-poppins w-auto sm:text-[22px] sm:font-normal sm:leading-6">
                    Elevate Your Expectations
                  </h3>
                  <div className=" flex justify-center items-center ml-4 lg:ml-2">
                    <Arrow />
                  </div>
                </div>
              </div>
