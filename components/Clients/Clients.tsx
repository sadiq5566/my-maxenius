    ...
    <div className="w-full h-[470px]  md:h-[301px] sm:h-[422px] xsm:h-[460px] bg-main relative">
      ...
      <div>
        <div className={`w-full`}>
          <div className="flex absolute -bottom-[70px]  md:-bottom-[40px]  justify-around w-full sm:flex-wrap  sm:h-[240px] xsm:h-[200px] sm:-bottom-[70px] sm:items-center xsm:items-start">
